...
class ColorRecognizerScreen extends StatefulWidget {
  const ColorRecognizerScreen({super.key});

  @override
  State<ColorRecognizerScreen> createState() => _ColorRecognizerScreenState();
}

class _ColorRecognizerScreenState extends State<ColorRecognizerScreen> {
  double red = 0;
  double green = 0;
  double blue = 0;
